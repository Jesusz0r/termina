...
2. **Headless run mode**: engine entry, host spawner, sidecar tailing under `bg-N`, settle/kill/retry. Tests: settle delivers a tool result; kill terminates the process group; crash reports failure.
