...
| 3 | `core/src/main.rs` | 11,210 → shrinking | Split protocol, Git, snapshot, promotion, and storage internals into Rust modules without moving Git behavior into TypeScript. Started: `trust.rs`, `repo.rs` extracted. |
