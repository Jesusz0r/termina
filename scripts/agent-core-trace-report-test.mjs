...
const cli = spawnSync(process.execPath, [join(import.meta.dirname, "agent-core-trace-report.mjs"), "--json", traces], {
  encoding: "utf8",
});
...
const fromEnv = spawnSync(process.execPath, [join(import.meta.dirname, "agent-core-trace-report.mjs"), "--json"], {
  encoding: "utf8",
