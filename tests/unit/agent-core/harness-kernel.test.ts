...
describe("Agent Core Kernel & TUI Harness Suite", () => {
  it("passes all kernel harness assertions natively", async () => {
    ...
    check(
      ...
      supportedEffortLevels("opencode-zen", "muse-spark-1.3-contributor-free", auth.providerProtocol("opencode-zen", "muse-spark-1.3-contributor-free")).join(" ") === "low medium high" &&
