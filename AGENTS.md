...
- `electron/terminal-runtime.ts` — only in-process terminal lifecycle (instance map, PTY spawn/exit, egress ledger, sidecar watch/queue, generation fence); main owns orchestration and IPC validation.
